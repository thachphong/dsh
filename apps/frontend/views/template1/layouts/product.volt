<html>
   <head>
      ...
      <meta name="description" content=" content="{{pro_name}}, {{description}}, kinh doanh không cần vốn, Chiết khấu cao, dropshoping Việt Nam">
	  <meta property="og:site_name" content="{{sitename}}">
	  <meta name="og:type" content="product" />
      <meta property="og:title" content="{{pro_name}} | {{sitename}}">
      <meta property="og:description" content="{{pro_name}}, {{description}}, kinh doanh không cần vốn, Chiết khấu cao, dropshoping Việt Nam">  
